...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        if args.use_cd:
            ...
            image_tensor_cd = model.transformer.visual.image_transform(image_tensor_cd).unsqueeze(0).to(model.device)
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--conv-mode", type=str, default="qwen-vl")
